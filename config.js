...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '256707521863'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  packname:  process.env.PACK_NAME || 'Made by MORICE UG',
  
  botname:   process.env.BOT_NAME === undefined ? "MORICE-MD" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'MORICE' : process.env.OWNER_NAME,  
