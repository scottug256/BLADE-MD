...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '256777902227'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
global.sudo = process.env.SUDO || "256777902227"
global.devs = '256777902227'
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'MARIE BOT',
  packname:  process.env.PACK_NAME || 'Made by MARIE',
  
  botname:   process.env.BOT_NAME === undefined ? "MARIE-MD" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'MARIE' : process.env.OWNER_NAME,  
